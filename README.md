...
[Visit Source](https://www.gonggames.com/#firstPage/1)
...
@font-face {
    ...
    font-style: normal;
    font-display: swap;
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/esamanru/esamanru-Regular.woff2') format('woff2'),
         url('https://cdn.jsdelivr.net/gh/fonts-archive/esamanru/esamanru-Regular.woff') format('woff'),
         url('https://cdn.jsdelivr.net/gh/fonts-archive/esamanru/esamanru-Regular.otf') format('opentype'),
         url('https://cdn.jsdelivr.net/gh/fonts-archive/esamanru/esamanru-Regular.ttf') format('truetype');
}
@font-face {
    font-family: 'esamanru';
    font-weight: 700;
